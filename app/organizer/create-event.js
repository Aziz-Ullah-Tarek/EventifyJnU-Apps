...
export default function CreateEventScreen() {
  ...
  useEffect(() => {
    const unsub = onAuthStateChanged(auth, (u) => {
      ...
      setUser(u);
      setOrganizer(u.displayName || u.email?.split('@')[0] || '');
    });
    return unsub;
  }, []);
        ...
        <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 60 }} showsVerticalScrollIndicator={false}>
          ...
          <View style={{ backgroundColor: '#FFF', borderRadius: 16, padding: 16, marginBottom: 16 }}>
            <View style={{ flexDirection: 'row', gap: 12, marginBottom: 14 }}>
              <View style={{ flex: 1 }}>
                <Text style={{ fontFamily: 'Poppins_600SemiBold', fontSize: 13, color: '#374151', marginBottom: 6 }}>Date *</Text>
                <TextInput style={{ backgroundColor: '#F9FAFB', borderWidth: 1, borderColor: '#E5E7EB', borderRadius: 10, padding: 12, fontFamily: 'Poppins_400Regular', fontSize: 14 }} placeholder="YYYY-MM-DD" placeholderTextColor="#9CA3AF" value={date} onChangeText={setDate} />
              </View>
              <View style={{ flex: 1 }}>
                <Text style={{ fontFamily: 'Poppins_600SemiBold', fontSize: 13, color: '#374151', marginBottom: 6 }}>Time *</Text>
                <TextInput style={{ backgroundColor: '#F9FAFB', borderWidth: 1, borderColor: '#E5E7EB', borderRadius: 10, padding: 12, fontFamily: 'Poppins_400Regular', fontSize: 14 }} placeholder="HH:MM" placeholderTextColor="#9CA3AF" value={time} onChangeText={setTime} />
              </View>
            </View>
